...
template_examples = [
    ...
    {"name": "Convert text to an OpenAI vector", "template_name": "text_to_ada_vector", "processor_type": "embedding"},
    ...
    {"name": "Split tasks", "template_name": "split_texts", "processor_type": "split_task"},
